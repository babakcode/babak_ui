...
class BabakUI extends StatefulWidget {


  static late SharedPreferences babakUIPref;
  ...
  @override
  State<BabakUI> createState() => _BabakUIState();
}

class _BabakUIState extends State<BabakUI> {
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          print('snapshot builder ## hasError');
          log('Error on init BabakUi ', name: 'BabakUI', error: snapshot.error);
        }
        if (snapshot.hasData) {
          BabakUI.babakUIPref = snapshot.data!;
          print('snapshot builder ## has Data');
          return MaterialApp(
