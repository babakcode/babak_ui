import 'package:babak_ui/babak_ui.dart';
import 'package:babak_ui/src/controller/changeable_controller.dart';
import 'package:babak_ui/src/services/requests.dart';
...
class _ChangeableState extends State<Changeable> {
  ...
  final BabakUIRequests _requests = BabakUIRequests(BabakUI.babakUIPref);
